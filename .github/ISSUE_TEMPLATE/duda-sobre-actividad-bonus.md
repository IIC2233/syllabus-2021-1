---
name: Duda sobre Actividad Bonus
about: Duda relacionada con la Actividad Bonus
title: Título descriptivo (reemplazar con el título apropiado)
labels: Actividad Bonus
assignees: ''

---

<!-- **Esta es una plantilla para que dejes dudas relacionadas con la actividad bonus. Si tienes dudas de otro tipo, utiliza la plantilla apropiada. Recuerda utilizar la pestaña "Preview" para ver cómo se vería tu *issue* antes de publicarla.** -->
